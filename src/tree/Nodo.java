...
public class Nodo {
	...
	public Nodo(){
		...
		labelNodo.addMouseListener(new MouseAdapter() {
			@Override
			/**Suma los nodos entre si.
			 * @param arg0 = click sobre las esferas*/
	...
	/**
	 * Verifica si la posici�n ya est� ocupada.
	 * @return ocupado = true si est� ocupada, false si no.*/
	...
	/**
	 *Asigna valor V/F a la posici�n del nodo.
	...
	/**
	 *Cambia la imagen del nodo gr�fico dado el valor num�rico.
	 *@param valor = valor del nodo.
	 * */
	...
	/**
	 *Busca la ubicaci�n de la imagen del nodo gr�fico dado el valor num�rico.
	 *@param valor = valor del nodo.
	 * */
